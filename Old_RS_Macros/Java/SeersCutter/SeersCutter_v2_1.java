...
@ScriptManifest(author = "0x6B", category = Category.WOODCUTTING, description = "Cuts trees at Seers Village. Automatic tree switching on level. Supports rune axe in inventory or equiped Bronze, Iron, or Rune axe."
		+ "Start in Seers bank.", 
name = "0xSeers Cutter", servers = { "Zenyte" }, version = "2.1", discord = "0x6b#7707")

public class SeersCutter_v2_1 extends Script {
